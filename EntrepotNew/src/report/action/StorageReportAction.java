...
@Scope("prototype")  
public class StorageReportAction extends SuperAction {  
    ...
    public String exportExcel() throws RowsExceededException, WriteException, IOException{
        ...
        ///创建可写入的Excel工作表  
            ...
            WritableSheet sheet=wk.createSheet("入库信息表", 0);  
        ...
        Label lab_01=new Label(0,1,"入库单号",cloumnTitleFormat);   
        Label lab_11=new Label(1,1,"入库日期",cloumnTitleFormat);  
        Label lab_21=new Label(2,1,"供应商",cloumnTitleFormat);    
        Label lab_31=new Label(3,1,"料号",cloumnTitleFormat);  
        Label lab_41=new Label(4,1,"名称",cloumnTitleFormat);  
        Label lab_51=new Label(5,1,"规格",cloumnTitleFormat);  
        Label lab_61=new Label(6,1,"数量",cloumnTitleFormat);  
        Label lab_71=new Label(7,1,"单位",cloumnTitleFormat);  
        Label lab_81=new Label(8,1,"单价",cloumnTitleFormat);  
        Label lab_91=new Label(9,1,"金额",cloumnTitleFormat);  
        Label lab_101=new Label(10,1,"入库人员",cloumnTitleFormat);  
        Label lab_111=new Label(11,1,"仓位选择",cloumnTitleFormat);  
        ...
        for(int i=0;i<list.size();i++){
      	  sheet.addCell(new Label(0,i+2,list.get(i).getStorageID(),cloumnTitleFormat));
      	  sheet.addCell(new Label(1,i+2,list.get(i).getWarehouse_Date().toString(),datewcf));
          sheet.addCell(new Label(2,i+2,list.get(i).getSupplier(),cloumnTitleFormat));
          sheet.addCell(new Label(3,i+2,list.get(i).getMaterial_Number(),cloumnTitleFormat));
          sheet.addCell(new Label(4,i+2,list.get(i).getName(),cloumnTitleFormat));
          sheet.addCell(new Label(5,i+2,list.get(i).getSpecifications(),cloumnTitleFormat));
          sheet.addCell(new Label(6,i+2,Long.toString(list.get(i).getNumber()),new WritableCellFormat(new NumberFormat("#") )));
          sheet.addCell(new Label(7,i+2,list.get(i).getUnit(),cloumnTitleFormat));
          sheet.addCell(new Label(8,i+2,Double.toString(list.get(i).getUnitPrice()),new WritableCellFormat(new NumberFormat("#.##") )));
          sheet.addCell(new Label(9,i+2,Double.toString(list.get(i).getAmount_money()),new WritableCellFormat(new NumberFormat("#.##") ) ));
          sheet.addCell(new Label(10,i+2,list.get(i).getWarehousePerson(),cloumnTitleFormat));
          sheet.addCell(new Label(11,i+2,list.get(i).getPosition_selection(),cloumnTitleFormat));
        }
